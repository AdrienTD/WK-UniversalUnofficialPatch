# Warrior Kings Universal Unoffical Patch (UUP)
...
See [extra/readme.txt](extra/readme.txt) for more extensive documentation (it's very long my bad 😂, may be simplified in the future).

## Building

You need Visual Studio 2010 or more recent versions, or the Windows 7 SDK.

1. Open the Visual Studio / Windows SDK command prompt.
